...
plot_creator.create_auto_correlation_plot('load', 96 * 7, title='Load autocorrelation', filename='load_au', save_plot=True, include_confidence_bounds=False)
...
#plot_creator.create_bar_chart(np.mean, 'load', 'year', save_plot=True, normalize=True, filename='load_over_year_mean_bar_chart_normalized')

# Temperature
#plot_creator.create_bar_chart(np.mean, 'temperature', 'day_of_week', save_plot=True, filename='test')
...
plot_creator.create_histogram('load', save_plot=True, title='Load distribution', filename='load_histogram', bins=50)
