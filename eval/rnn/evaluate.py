...
# plot_creator.plot_predictions(y_true[15], y_pred[15], file_name_rnn_32_15, 'rnn', freq='1h', show_plot=True)
# plot_creator.plot_predictions(y_true20[15], y_pred20[15], file_name_rnn_32_20, 'rnn', freq='1h', show_plot=True)
# plot_creator.plot_predictions(y_true_64_15[15], y_pred_64_15[15], file_name_rnn_64_15, 'rnn', freq='1h', show_plot=True)
plot_creator.plot_predictions(y_true_64_20[15], y_pred_64_20[15], file_name_rnn_64_20, 'rnn', freq='1h', show_plot=True)
